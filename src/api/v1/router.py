...
from api.v1.endpoints.cooking_history import router as cooking_history_router
...
api_router.include_router(cooking_history_router, prefix="/cooking-history", tags=["cooking-history"])
